...
1B to 3B.  Few-shot CoT and self-consistency raised accuracy
substantially at the 3B and coder scales.  On GSM8K the algorithmic
effect ratio is near one (0.82--1.00) as a point estimate, although
the bootstrap intervals around these estimates are wide; the
...
scales, with the observed endpoint changes within the bootstrap
...
few-shot CoT at the 3B model (70\% to 79\%), whose 95\%
...
shortfall relative to direct answering is significant at the 1B model
